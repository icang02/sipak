      ...
      <tr class="text-center text-dark">
        ...
        @if (!request()->is('data-pkb/export'))
          <td class="text-nowrap">
            ...
            <form action="{{ route('hapus.pkb', $item->id) }}" class="d-inline" method="post">
              @csrf
              @method('delete')
              <button onclick="return confirm('Semua data pegawai ini akan dihapus. Lanjutkan untuk menghapus?')"
                type="submit" class="btn btn-danger badge" style="border-radius: 4px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
