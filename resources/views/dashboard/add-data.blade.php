  ...
  <div class="main-content container-fluid">
    ...
    <div class="col-md-12">
      <div class="d-flex mb-2 justify-content-between">
        <a href="{{ route('data.pkb') }}" class="btn btn-secondary">Kembali</a>
        {{-- <div>
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('tambah.pkb') }}" method="POST">
            @csrf
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="mt-3">
                <button style="transition: .3s;" id="submit" type="submit" class="btn btn-primary">Tambah</button>
