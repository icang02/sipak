                ...
                <form class="form form-horizontal">
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group">
                        <input value="{{ $data->nip }}" type="email" id="email-id" class="form-control"
                          name="email-id" placeholder="NIP" disabled>
                      </div>
                      <div class="col-md-4">
                        <label>Jabatan</label>
                      </div>
                      <div class="col-md-8 form-group">
                        <input value="{{ $data->jabatan->nama }}" type="text" id="contact-info" class="form-control"
                          name="contact" placeholder="Jabatan" disabled>
                      </div>
                      <div class="col-md-4">
                        <label>Pangkat / Golongan</label>
                      </div>
                      <div class="col-md-8 form-group">
                        <input value="{{ $data->pangkat . ' - ' . $data->golongan }}" type="text" id="password"
                          class="form-control" name="password" placeholder="Pangkat / Golongan" disabled>
                      </div>
